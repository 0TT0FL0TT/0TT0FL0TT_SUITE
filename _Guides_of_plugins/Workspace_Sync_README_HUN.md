...
- **Elavult bejegyzések törlése:** ha egy tabot kivesznek egy workspace-ből, a pozíció bejegyzése automatikusan törlődik — nincs szükség manuális beavatkozásra. A nem mentett tabok (megnyitottak, de "Save workspace"-szel nem rögzítettek) sem kerülnek bele a `scroll-positions.json`-ba.
...
**A gyakorlatban, ha egyáltalán használsz workspace-eket, szinte mindig ez a plugin pozíciója érvényesül.** Az Obsidianban nincs workspace-en kívüli állapot — mindig valamelyikben vagy. Ez azt jelenti, hogy a Remember Cursor Position / Cursor Navigator csak akkor lép valóban működésbe, ha nulla mentett workspace-ed van, vagy olyan fájlt nyitsz meg, amely soha nem volt egyetlen mentett workspace-ben sem.

Nem kell eltávolítani egyik plugint sem. Zavartalanul megférnek egymás mellett — de ha következetesen workspace-eket használsz, a kurzor-követő plugin nagyrészt feleslegessé válik, és nyugodtan kikapcsolható.
